...
const plans = [
  {
    ...
    features: ["Monitor up to 3 drives", "Open drive", "Safe eject", "Basic notifications"],
    cta: "Download Free",
    highlighted: false,
  },
  {
    ...
    features: ["Unlimited drives", "Open drive", "Safe eject", "Eject all", "Priority updates", "Premium UI"],
    cta: "Upgrade to Pro",
    highlighted: true,
  },
];
